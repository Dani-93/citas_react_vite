...
const Formulario = ({pacientes, setPacientes, paciente, setPaciente}) => {
  ...
  return (
    <div className="w-1/2">
        <h2 className="font-black text-3xl text-center">Seguimientos 
        Pacientes</h2>
        ...
        className="bg-withe shadow-md rounded-lg py-10 px-5">
          ...
          <div className="mb-7">
            ...
            className="border-2 w-full p-2 mt-2 placeholder-purple-700 rounded-md"
            value={nombre}
